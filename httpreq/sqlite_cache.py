...
class CacheWithDB:
    ...
    def is_full(self, data):
        ...
        return cache_size + sys.getsizeof(data) > MAXIMUM_CAPACITY
    ...
    def remove_least_priority_data(self, file_size):
        ...
        while self.get_size() + file_size >= MAXIMUM_CAPACITY:
            print("Removing least priority data")
